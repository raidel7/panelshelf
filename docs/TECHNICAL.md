# PanelShelf — technical reference

Everything about how PanelShelf works, for people who want the detail: the
security model, the HTTP and OPDS surface, the scanning and metadata rules,
operational behaviour on DSM, and how to build it yourself.

Start at the [README](../README.md) if you just want to install it and read
comics.
